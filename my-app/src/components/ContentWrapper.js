      ...
      <ul className="navbar-nav ml-auto">
        ...
        <li className="nav-item dropdown no-arrow">
          <a className="nav-link dropdown-toggle" href="/" id="userDropdown">
            ...
            <img className="img-profile rounded-circle" src="assets/images/jordan-walke.png" alt="Jordan Walke - Creador de React" width="60"></img>
          </a>
        </li>
          ...
          <div className="card shadow mb-4">
            ...
            <div className="card-body">
              <div className="text-center">
                <img className="img-fluid px-3 px-sm-4 mt-3 mb-4" style={{width: "40rem"}} src="assets/images/mandalorian.jpg" alt=" Star Wars - Mandalorian "></img>
              </div>
